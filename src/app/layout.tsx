...
export const metadata: Metadata = {
  ...
  description:
    "LenaBara Media — performance marketing specialist in Dubai, UAE. Meta Ads, Google Ads, conversion tracking, GA4 setup, and lead generation systems for UAE businesses.",
  metadataBase: new URL("https://www.lenabara.com"),
  openGraph: {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-TV8TCZ4G');`}
        </Script>
      </head>
      <body
      ...
      >
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TV8TCZ4G"
            height="0"
            width="0"
